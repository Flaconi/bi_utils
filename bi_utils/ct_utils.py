...
def ct_pagination_by_sort_key_limit(ct_client_id, clt_client_pwd, endpoint, sort_key, 
                              max_timestamp=None, columns=None, cols_to_exclude=None, 
                              staged=True, max_iterations=250, expand='',
                              base_url='https://api.europe-west1.gcp.commercetools.com/flaconi-prod/',
                              limit=500):
    ...
    """
    if limit>500:
        logger.info(f'The limit {limit} is higher than allowed. It should not be higher than 500.')
